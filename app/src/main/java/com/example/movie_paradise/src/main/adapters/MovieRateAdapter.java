...
import com.example.movie_paradise.src.main.RatingActivity;
import com.example.movie_paradise.src.main.items.MovieItem;

import java.util.ArrayList;

public class MovieRateAdapter extends RecyclerView.Adapter<MovieRateAdapter.CustomViewHolder> {

    private ArrayList<MovieItem> movie_item_list;

    private OnItemClickListener mListener = null;

    public MovieRateAdapter(ArrayList<MovieItem> movie_item_list) {
    ...
    @NonNull
    @Override
    public MovieRateAdapter.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MovieRateAdapter.CustomViewHolder holder, int position) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (pos != RecyclerView.NO_POSITION) {
                        ...
                        intent.putExtra("movie_name", movie_item_list.get(pos).getMovieName());
